...
A LangGraph application that takes a CSV file and natural language question as input, and generates Python code to analyze the CSV data and answer the question.
...
3. **Execution**: Optionally, the generated code can be saved to a file and executed directly from the CLI.
